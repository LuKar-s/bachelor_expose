...
Um wiederverwendbare Maschinen-Images zu erstellen kann das Tool Packer helfen. Packer ermöglicht das Erstellen von Konfigurationen, aus denen Maschinen-Images für unterschiedliche Plattformen erstellt werden können. Durch diesen Ansatz werden Maschinenimages wiederverwendbar und Änderung an diesen sind nachvollziehbar und widerruflich. Zusätzlich können über verschiedene Instanzen genutzte Grund-Images, auch Golden Image \cite{GoldenImage:2018} genannt für eine einheitliche und erleichterte Wartung der Systeme sorgen. Weiter sind Konzepte und Tools benötigt, welche den Anwendungsbetrieb und ihre Bereitstellung
sicher, einfach zu administrieren und unanfällig für Fehler macht. Das Verwalten von Geheimnissen, Orchestrieren und Registrieren von Services sind hier zu nennen.


Startnext-Anwendung bräuchte neue Ansätze bezüglich Logging etc

Automatisierung

Automatisierung benötigt QM (Testing)
